    ...
    return (
        <footer className='bg-[#2E3090]'>
            <div>
                ...
                {/* Check why isn't showing this code  */}
                <div className="md:flex gap-14 ml-10 pt-8 pb-5 border-[#cfcccc] border-b-[1px] hidden">
                    <h1 className="text-white text-2xl md:text-3xl">Where to buy</h1>
                    <h1 className="text-white text-xl md:text-xl">Our Products are currently available in <br /> Lebanese stores</h1>
                </div>
                ...
                <div className='flex flex-col md:flex-row justify-between md:pt-5 pb-2'>
                    ...
                    <div className='flex gap-2 mx-10 pt-5 lg:mx-52'>
